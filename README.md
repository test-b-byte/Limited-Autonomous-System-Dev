...
**Limited Autonomous Systems (LAS)** is a systems-design concept for building cheap, attributable, distributed autonomous capability, not a single product. Both allied forces (notably Ukraine) and adversarial actors (Iran) have demonstrated the strategic advantage of cheap, attributable systems over exquisite, high-cost platforms. U.S. and NATO doctrine has largely bet on AI-enabled autonomy and higher-quality systems to offset peer and near-peer adversaries' larger personnel reserves. In practice, this has produced a kind of pseudo-innovation spiral: companies promise advanced autonomous capability, but the actual enabling advantage of small autonomous platforms, drones included, is low mass and low cost, not intelligence.
...
LAS targets two critical areas where effective sensing and human-machine collaboration bottleneck the broader goal of cheap, attributable, distributed systems.
...
As technology changes the character of conflict, established command structures are shifting. Command and control (C2) is no longer a squad leader and a radio operator. It is the information-dissemination axis of a small swarm or Limited Autonomous fighting force.
